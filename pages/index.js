...

    {
        ...
        <div className='InnerLoginLanding'>
            ...
            <div className='LoginContainer'>
                ...
                <div className='InnerLoginContainer'>
                        <button><FaDiscord className='LoginIcon' /> سجل دخولك بديسكورد</button>
                        <button><FaFacebookF className='LoginIcon' /> سجل دخولك بفيس بوك</button>
                        <button><BsTwitch id='TwitchIcon' className='LoginIcon' /> سجل دخولك تويتش</button>
                        <button><BsGoogle id='GoogleIcon' className='LoginIcon' /> سجل دخولك بجوجل</button>
        ...
        <header className='LandingHeader' id='LandingHeaderID'>
              ...
              <div className='RightLandingHeader'>
                  <Link href="/" data-replace="الرئيسية"><span>الرئيسية</span></Link>
                  <Link href="#Sharek" data-replace="شارك"><span>شارك</span></Link>
                  <Link href="#Endam" data-replace="إنضم"><span>إنضم</span></Link>
                  <Link href="#El3ab" data-replace="إلعب"><span>إلعب</span></Link>
                  <button onClick={()=>setLogin(!Login)}><SiRiotgames id='LandingHeaderIcon' /> إنتمــي</button>
